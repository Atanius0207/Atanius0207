...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&pause=1000&color=3B82F6&center=true&vCenter=true&width=600&lines=UPI+YPTK+PADANG+%7C+Informatics+Engineering;Web+Developer+%26+Backend+Enthusiast;Always+Learning+New+Technologies" alt="Typing SVG" />
  ...
  <tr>
    <td width="50%">
      ...
      <div align="center">
        ...
        <p><strong>QR Code Based</strong> - Attendance system built with Laravel featuring QR code scanning and real-time monitoring</p>
      </div>
    </td>
    <td width="50%">
      ...
      <div align="center">
        ...
        <p><strong>Student Management</strong> - Complete CRUD system for managing student data with modern UI</p>
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%">
      ...
      <div align="center">
        ...
        <p><strong>Inventory System</strong> - Complete inventory management system with stock tracking and reporting features</p>
      </div>
    </td>
    <td width="50%">
      ...
      <div align="center">
        ...
        <p><strong>Mobile App</strong> - Music player app built with Flutter for Android devices</p>
      </div>
    </td>
  </tr>
</table>
...
const fahrel = {
    pronouns: "He" | "Him",
    code: ["PHP", "JavaScript", "Dart", "HTML", "CSS"],
    askMeAbout: ["web dev", "backend", "Laravel", "database design"],
    technologies: {
        backEnd: {
            php: ["Laravel"],
        },
    ...
    currentFocus: "Building scalable backend systems with Laravel",
